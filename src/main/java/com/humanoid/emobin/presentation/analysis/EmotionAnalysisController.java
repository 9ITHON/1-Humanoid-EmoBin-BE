...
public class EmotionAnalysisController {
    ...
    @PostMapping
    public ResponseEntity<EmotionAnalysisResult> analyzeEmotion(@RequestBody EmotionAnalysisCommand command) throws IOException {
        EmotionAnalysisResult result = emotionAnalysisService.analyze(command);
